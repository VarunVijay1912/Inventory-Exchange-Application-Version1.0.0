...
var t = (t2) => {
  if ("object" == typeof window) {
    let e2 = (t2 ? t2.querySelector("#_goober") : window._goober) || Object.assign((t2 || document.head).appendChild(document.createElement("style")), { innerHTML: " ", id: "_goober" });
    return window.__nonce__ && e2.setAttribute("nonce", window.__nonce__), e2.firstChild;
  }
  return t2 || e;
};
var l = /(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g;
...
var o = (e2, t2) => {
  ...
  for (let a2 in e2) {
    let c2 = e2[a2];
    "@" == a2[0] ? "i" == a2[1] ? r = a2 + " " + c2 + ";" : l2 += "f" == a2[1] ? o(c2, a2) : a2 + "{" + o(c2, "k" == a2[1] ? "" : t2) + "}" : "object" == typeof c2 ? l2 += o(c2, t2 ? t2.replace(/([^,])+/g, (e3) => a2.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g, (t3) => /&/.test(t3) ? t3.replace(/&/g, e3) : e3 ? e3 + " " + t3 : t3)) : a2) : null != c2 && (a2 = /^--/.test(a2) ? a2 : a2.replace(/[A-Z]/g, "-$&").toLowerCase(), n3 += o.p ? o.p(a2, c2) : a2 + ":" + c2 + ";");
  }
  return r + (t2 && n3 ? t2 + "{" + n3 + "}" : n3) + l2;
};
var c = {};
var i = (e2) => {
  if ("object" == typeof e2) {
...
var s = (e2, t2, r, s2, u2) => {
  ...
  if (!c[d2]) {
    let t3 = p2 !== e2 ? e2 : ((e3) => {
      let t4, r2, o2 = [{}];
      for (; t4 = l.exec(e3.replace(n, "")); ) t4[4] ? o2.shift() : t4[3] ? (r2 = t4[3].replace(a, " ").trim(), o2.unshift(o2[0][r2] = o2[0][r2] || {})) : o2[0][t4[1]] = t4[2].replace(a, " ").trim();
      return o2[0];
    })(e2);
    c[d2] = o(u2 ? { ["@keyframes " + d2]: t3 } : t3, r ? "" : "." + d2);
  }
...
var u = (e2, t2, r) => e2.reduce((e3, l2, n3) => {
  let a2 = t2[n3];
  if (a2 && a2.call) {
    let e4 = a2(r), t3 = e4 && e4.props && e4.props.className || /^go/.test(e4) && e4;
    a2 = t3 ? "." + t3 : e4 && "object" == typeof e4 ? e4.props ? "" : o(e4, "") : false === e4 ? "" : e4;
  }
  return e3 + l2 + (null == a2 ? "" : a2);
}, "");
function p(e2) {
  let r = this || {}, l2 = e2.call ? e2(r.p) : e2;
  return s(l2.unshift ? l2.raw ? u(l2, [].slice.call(arguments, 1), r.p) : l2.reduce((e3, t2) => Object.assign(e3, t2 && t2.call ? t2(r.p) : t2), {}) : l2, t(r.target), r.g, r.o, r.k);
}
var d;
var f;
var g;
...
function w(e2, t2) {
  ...
  return function() {
    let l2 = arguments;
    function n3(a2, o2) {
      let c2 = Object.assign({}, a2), i2 = c2.className || n3.className;
      r.p = Object.assign({ theme: f && f() }, c2), r.o = / *go\d+/.test(i2), c2.className = p.apply(r, l2) + (i2 ? " " + i2 : ""), t2 && (c2.ref = o2);
      let s2 = e2;
